...
run: salernos.iso
	qemu-system-x86_64 -M q35 -m 12000m -enable-kvm -smp cpus=8 -no-shutdown -no-reboot -debugcon file:/dev/stdout -serial file:/dev/stdout -netdev user,id=net0 -device virtio-net,netdev=net0 -object filter-dump,id=f1,netdev=net0,file=netdump.dat -cdrom salernos.iso -display spice-app,gl=on
